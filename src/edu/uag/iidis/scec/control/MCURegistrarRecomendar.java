...
public final class MCURegistrarRecomendar 
    ...
    public ActionForm consultarAjax(){
    ...
    public ActionForward procesarRegistroRecomendar(
        ...
        Recomendar recomendar = new Recomendar(forma.getNombre(),
                          forma.getFecha(),forma.getComentario(),forma.getCalificacion(),forma.getidLugar());
