...
<!--
  function EliminarLugar(strLugarName){
    return confirm("¿Desea eliminar el lugar '" + strLugarName + "'?")
  }
-->
</script>
    <br>
    ...
    <table cellpadding="0" cellspacing="0" width="60%" border="0">
        ...
        <tr bgcolor="#CCCCCC">
		 ...
		 <td><b><fmt:message key="formaListadoLugares.etiqueta.imagen" /></b></td>
		 ...
		 <td style="border-right-style:solid; border-left-style:solid; border-width:1px; border-color:#000000;"><b><fmt:message key="formaListadoLugares.etiqueta.coordenada" /></b></td>
        ...
        <c:forEach var="lugar" items="${formaListadoLugares.lugares}">
            <tr>
				...
				<td align="left" width="20%"><img src="images/<c:out value="${lugar.imagen}"/>" height="50" width="50"/></td>
